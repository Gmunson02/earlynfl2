  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-1 mb-5">
          {isSignUp ? "Join the league in a few seconds" : "Log in to make your picks"}
        </p>
        ...
        <button
          ...
          className="w-full mt-5 text-center text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline"
        >
